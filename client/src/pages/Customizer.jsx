...
const Customizer = () => {
  ...
  const handleSubmit = async (type) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://project-threejs-l703.onrender.com/api/v1/dalle",
        {
          method: "POST",
          headers: {
  ...
  const getImageScalingY = (dataURL) => {
  ...
  const handleDecals = async (type, result) => {
    ...
    const imgScalingY = await getImageScalingY(result);
    state[`${decalType}Scaling`] = imgScalingY;
